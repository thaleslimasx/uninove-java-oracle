 ...
 * @author TARDIS
 */
public class TabelaP extends JFrame{
    ...
    peticoes FrmProcesso; // criação da variavel do objeto Cliente
    
    public TabelaP(JFrame pPeticoes) {
        
        List<String []> ListDados = new ArrayList(); // criação da lista de dados
       
        FrmProcesso = (peticoes) pPeticoes; // inicialização do objeto Cliente
        ...
        String Headers[] = {"id", "nºprocesso","Tipo de Petição","Data"};  // Inicialização do headers da tabela
